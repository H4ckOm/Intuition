...
import { IntuitionManager } from "./managers/IntuitionManager.js";
...
class Intuition extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      players: [
        { x: props.player1x || -1, y: props.player1y || -1, moves: [{}] },
        { x: props.player2x || -1, y: props.player2y || -1, moves: [{}] },
      ],
      grid: props.grid,
    ...
    this.state.players[0].moves = IntuitionManager.allMoves(
      0,
      this.state.players,
      props.width,
      props.height
    );
    this.state.players[1].moves = IntuitionManager.allMoves(
      1,
      this.state.players,
      props.width,
      props.height
  ...
  onGrid(x, y, values) {
    ...
    if (
      ...
      players[0].moves = IntuitionManager.availableMoves(
        0,
        players,
        values,
        this.grid.current.props.width,
      ...
      players[1].moves = IntuitionManager.availableMoves(
        1,
        players,
        values,
        this.grid.current.props.width,
      ...
      <div id="app" ref={this.container}>
        ...
        <div class="row">
          <div class="col col-auto">
            <div
              class={`badge ${
                !this.state.playerIndex ? "badge-primary" : "badge-warning"
              }`}
            >
              Player {this.state.playerIndex + 1}'s Turn
            </div>
          </div>
          <div class="col col-auto">
          ...
          <div class="col col-auto">
            <div class={`badge badge-success ${!moves ? "" : "d-none"}`}>
