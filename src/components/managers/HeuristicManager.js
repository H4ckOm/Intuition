export const HeuristicManager = {
  ...
  defensiveToOffensive: function (
    ...
    return ratio <= 0.5
      ? HeuristicManager.defensive(playerMoves, opponentMoves)
      : HeuristicManager.offensive(playerMoves, opponentMoves);
  },

  offensiveToDefensive: function (
    playerMoves,
    opponentMoves,
    width,
    height,
